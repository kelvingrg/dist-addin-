"use strict";
(self["webpackChunkoffice_addin_taskpane_react_js"] = self["webpackChunkoffice_addin_taskpane_react_js"] || []).push([["src_taskpane_commonComponents_Bom_BomGet_BomGet_js"],{

/***/ "./src/taskpane/commonComponents/Bom/BomGet/BomGet.js":
/*!************************************************************!*\
  !*** ./src/taskpane/commonComponents/Bom/BomGet/BomGet.js ***!
  \************************************************************/
...
/* harmony import */ var _BomGet_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./BomGet.css */ "./src/taskpane/commonComponents/Bom/BomGet/BomGet.css");
...
function BomGet() {
  ...
  var _useState11 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
    ...
    addNewBomMaterial = _useState12[0],
    setAddNewBomMaterial = _useState12[1];
  var _useState13 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
    _useState14 = _slicedToArray(_useState13, 2),
    prodCodeLoading = _useState14[0],
    setProdCodeLoading = _useState14[1];
  var _useState15 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
    _useState16 = _slicedToArray(_useState15, 2),
    bomLoading = _useState16[0],
    setBomLoading = _useState16[1];
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    if ((activeProject === null || activeProject === void 0 ? void 0 : activeProject.id) === "Master") {
      ...
      try {
        ...
        (0,_api_apiCalls__WEBPACK_IMPORTED_MODULE_10__.runQuery)(_config__WEBPACK_IMPORTED_MODULE_2__.DTX_GRAPHQL_URL, localStorage.getItem("tenantToken"), body).then(function (data) {
          if (data.errors) {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            if (bomMappingData.quantity && bomMappingData.total_price && bomMappingData.unit_size && bomMappingData.id && bomMappingData !== null && bomMappingData !== void 0 && bomMappingData.custom_material_id && bomMappingData !== null && bomMappingData !== void 0 && bomMappingData.associated_product_code_bom) {
              ...
              try {
                ...
                (0,_api_apiCalls__WEBPACK_IMPORTED_MODULE_10__.runQuery)(_config__WEBPACK_IMPORTED_MODULE_2__.DTX_GRAPHQL_URL, token, body).then( /*#__PURE__*/function () {
                  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(data) {
                    var _data$data10, _data$data11, _data$data11$bom_item, _data$data12, _data$data12$bom_item, sheetname, i, _data$data13, _data$data13$bom_item, _data$data14;
                    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                      while (1) switch (_context2.prev = _context2.next) {
                        ...
                        case 4:
                          ...
                          _context2.next = 7;
                          return (0,_constFunctions_excelFunction__WEBPACK_IMPORTED_MODULE_6__.changeActiveSheetName)(selectedBom === null || selectedBom === void 0 ? void 0 : selectedBom.label, data === null || data === void 0 ? void 0 : (_data$data11 = data.data) === null || _data$data11 === void 0 ? void 0 : (_data$data11$bom_item = _data$data11.bom_items[0]) === null || _data$data11$bom_item === void 0 ? void 0 : _data$data11$bom_item.bom_version_id);
                        case 7:
                          ...
                          (0,_constFunctions_excelFunction__WEBPACK_IMPORTED_MODULE_6__.setCustomPropertyData)(activeSheetId, {
                            bomVersionId: data === null || data === void 0 ? void 0 : (_data$data12 = data.data) === null || _data$data12 === void 0 ? void 0 : (_data$data12$bom_item = _data$data12.bom_items[0]) === null || _data$data12$bom_item === void 0 ? void 0 : _data$data12$bom_item.bom_version_id,
                            productCodeId: selectedProdCode === null || selectedProdCode === void 0 ? void 0 : selectedProdCode.value,
                            productCodeLabel: selectedProdCode === null || selectedProdCode === void 0 ? void 0 : selectedProdCode.label,
                            bomId: selectedBom === null || selectedBom === void 0 ? void 0 : selectedBom.value,
                            bomLabel: selectedBom === null || selectedBom === void 0 ? void 0 : selectedBom.label
                          });
                          ...
                          for (i = 0; i < (data === null || data === void 0 ? void 0 : (_data$data13 = data.data) === null || _data$data13 === void 0 ? void 0 : (_data$data13$bom_item = _data$data13.bom_items) === null || _data$data13$bom_item === void 0 ? void 0 : _data$data13$bom_item.length); i++) {
                            (0,_constFunctions_excelFunction__WEBPACK_IMPORTED_MODULE_6__.writeToExcelforBOM)(sheetname, i, data === null || data === void 0 ? void 0 : (_data$data14 = data.data) === null || _data$data14 === void 0 ? void 0 : _data$data14.bom_items[i], bomMappingData);
                          }
                          // to hide unwanted columns
                          _constFunctions_constants__WEBPACK_IMPORTED_MODULE_7__.HIDE_COLUMNS === null || _constFunctions_constants__WEBPACK_IMPORTED_MODULE_7__.HIDE_COLUMNS === void 0 ? void 0 : _constFunctions_constants__WEBPACK_IMPORTED_MODULE_7__.HIDE_COLUMNS.forEach( /*#__PURE__*/function () {
                            var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(element) {
                              return _regeneratorRuntime().wrap(function _callee$(_context) {
                                while (1) switch (_context.prev = _context.next) {
                                  case 0:
                                    ...
                                    _context.next = 3;
                                    return (0,_constFunctions_excelFunction__WEBPACK_IMPORTED_MODULE_6__.hideColumn)(bomMappingData[element].address);
                                  case 3:
                                  case "end":
  ...
  var writeHeadings = /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(i, key) {
    ...
    return function writeHeadings(_x4, _x5) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    className: "bom-addnewmaterial",
    onClick: function onClick() {
      return setAddNewBomMaterial(true);
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Button_Button__WEBPACK_IMPORTED_MODULE_3__["default"], {
    label: "Add Material"
  }))), addNewBomMaterial && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Suspense, {
...
/***/ "./node_modules/css-loader/dist/cjs.js!./src/taskpane/commonComponents/Bom/BomGet/BomGet.css":
/*!***************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./src/taskpane/commonComponents/Bom/BomGet/BomGet.css ***!
  \***************************************************************************************************/
...
/***/ "./src/taskpane/commonComponents/Bom/BomGet/BomGet.css":
/*!*************************************************************!*\
  !*** ./src/taskpane/commonComponents/Bom/BomGet/BomGet.css ***!
  \*************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_BomGet_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../../../../node_modules/css-loader/dist/cjs.js!./BomGet.css */ "./node_modules/css-loader/dist/cjs.js!./src/taskpane/commonComponents/Bom/BomGet/BomGet.css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_BomGet_css__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ __webpack_exports__["default"] = (_node_modules_css_loader_dist_cjs_js_BomGet_css__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_BomGet_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_BomGet_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
//# sourceMappingURL=src_taskpane_commonComponents_Bom_BomGet_BomGet_js.js.map