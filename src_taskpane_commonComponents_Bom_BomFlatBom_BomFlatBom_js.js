"use strict";
(self["webpackChunkoffice_addin_taskpane_react_js"] = self["webpackChunkoffice_addin_taskpane_react_js"] || []).push([["src_taskpane_commonComponents_Bom_BomFlatBom_BomFlatBom_js"],{

/***/ "./src/taskpane/commonComponents/Bom/BomFlatBom/BomFlatBom.js":
/*!********************************************************************!*\
  !*** ./src/taskpane/commonComponents/Bom/BomFlatBom/BomFlatBom.js ***!
  \********************************************************************/
...
/* harmony import */ var _BomFlatBom_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./BomFlatBom.css */ "./src/taskpane/commonComponents/Bom/BomFlatBom/BomFlatBom.css");
...
function BomFlatBom() {
  ...
  var _useState9 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
    ...
    coreMaterialsBom = _useState10[0],
    setCoreMaterailBom = _useState10[1];
  var _useState11 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
    _useState12 = _slicedToArray(_useState11, 2),
    prodCodeLoading = _useState12[0],
    setProdCodeLoading = _useState12[1];
  var _useState13 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
    _useState14 = _slicedToArray(_useState13, 2),
    bomLoading = _useState14[0],
    setBomLoading = _useState14[1];

  // this useEffect fectches all product codes while loading this page
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    //if any projext has selected except master then  no need to load prod code
    if ((activeProject === null || activeProject === void 0 ? void 0 : activeProject.id) === "Master") {
      ...
      try {
        ...
        (0,_api_apiCalls__WEBPACK_IMPORTED_MODULE_10__.runQuery)(_config__WEBPACK_IMPORTED_MODULE_2__.DTX_GRAPHQL_URL, _token, _body).then(function (data) {
          if (data.errors) {
            data.errors.map(function (element) {
              if (element !== null && element !== void 0 && element.message.includes(_constFunctions_constants__WEBPACK_IMPORTED_MODULE_7__.JWT_ERROR_MESSAGE)) {
                (0,_constFunctions_copmponentFunctions__WEBPACK_IMPORTED_MODULE_9__.logout)();
            ...
            var _loop2 = function _loop2(i) {
              setAllBomDetails(function (prevState) {
                var _data$data5, _data$data5$core_bom$, _data$data6, _data$data6$core_bom$;
                return [].concat(_toConsumableArray(prevState), [{
                  label: data === null || data === void 0 ? void 0 : (_data$data5 = data.data) === null || _data$data5 === void 0 ? void 0 : (_data$data5$core_bom$ = _data$data5.core_bom[i]) === null || _data$data5$core_bom$ === void 0 ? void 0 : _data$data5$core_bom$.name,
                  value: data === null || data === void 0 ? void 0 : (_data$data6 = data.data) === null || _data$data6 === void 0 ? void 0 : (_data$data6$core_bom$ = _data$data6.core_bom[i]) === null || _data$data6$core_bom$ === void 0 ? void 0 : _data$data6$core_bom$.id
                }]);
              });
            };
            for (var i = 0; i < (data === null || data === void 0 ? void 0 : (_data$data4 = data.data) === null || _data$data4 === void 0 ? void 0 : (_data$data4$core_bom = _data$data4.core_bom) === null || _data$data4$core_bom === void 0 ? void 0 : _data$data4$core_bom.length); i++) {
              var _data$data4, _data$data4$core_bom;
              _loop2(i);
            }
          }
        }).catch(function (error) {
      ...
      (0,_api_apiCalls__WEBPACK_IMPORTED_MODULE_10__.runQuery)(_config__WEBPACK_IMPORTED_MODULE_2__.DTX_GRAPHQL_URL, token, body).then(function (data) {
        if (data.errors) {
          ...
          var _loop3 = function _loop3(i) {
            setAllBomDetails(function (prevState) {
              var _data$data8, _data$data8$core_bom$, _data$data9, _data$data9$core_bom$;
              return [].concat(_toConsumableArray(prevState), [{
                label: data === null || data === void 0 ? void 0 : (_data$data8 = data.data) === null || _data$data8 === void 0 ? void 0 : (_data$data8$core_bom$ = _data$data8.core_bom[i]) === null || _data$data8$core_bom$ === void 0 ? void 0 : _data$data8$core_bom$.name,
                value: data === null || data === void 0 ? void 0 : (_data$data9 = data.data) === null || _data$data9 === void 0 ? void 0 : (_data$data9$core_bom$ = _data$data9.core_bom[i]) === null || _data$data9$core_bom$ === void 0 ? void 0 : _data$data9$core_bom$.id
              }]);
            });
          };
          for (var i = 0; i < (data === null || data === void 0 ? void 0 : (_data$data7 = data.data) === null || _data$data7 === void 0 ? void 0 : (_data$data7$core_bom = _data$data7.core_bom) === null || _data$data7$core_bom === void 0 ? void 0 : _data$data7$core_bom.length); i++) {
            var _data$data7, _data$data7$core_bom;
            _loop3(i);
          }
        }
      }).catch(function (error) {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ...
            if (bomMappingData.quantity && bomMappingData.id && bomMappingData !== null && bomMappingData !== void 0 && bomMappingData.custom_material_id) {
              ...
              try {
                ...
                (0,_api_apiCalls__WEBPACK_IMPORTED_MODULE_10__.runQuery)(_config__WEBPACK_IMPORTED_MODULE_2__.DTX_GRAPHQL_URL, localStorage.getItem("tenantToken"), body).then( /*#__PURE__*/function () {
                  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(data) {
                    var _data$data10, _data$data11, flatBomData, getFlatBomData, _getFlatBomData, sheetname, i;
                    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                      while (1) switch (_context3.prev = _context3.next) {
                        case 0:
                          ...
                          break;
                        case 4:
                          _getFlatBomData = function _getFlatBomData3() {
                            _getFlatBomData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(bomVersionId) {
                              var bomQuantity,
                                body,
                                _args2 = arguments;
                              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                                while (1) switch (_context2.prev = _context2.next) {
                                  case 0:
                                    bomQuantity = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : 1;
                                    body = {
                                    ...
                                    return (0,_api_apiCalls__WEBPACK_IMPORTED_MODULE_10__.runQuery)(_config__WEBPACK_IMPORTED_MODULE_2__.DTX_GRAPHQL_URL, localStorage.getItem("tenantToken"), body).then( /*#__PURE__*/function () {
                                      var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
                                        var _i2, _data$data12, _data$data12$bom_item, _data$data$bom_items$, _data$data13, _data$data13$bom_item, _i3, _data$data$bom_items$3, findsameData, j, _ref6, _data$data$bom_items$2, _ref7;
                                        return _regeneratorRuntime().wrap(function _callee$(_context) {
                                          while (1) switch (_context.prev = _context.next) {
                                            ...
                                            case 4:
                                              _i2 = 0;
                                            case 5:
                                              if (!(_i2 < (data === null || data === void 0 ? void 0 : (_data$data12 = data.data) === null || _data$data12 === void 0 ? void 0 : (_data$data12$bom_item = _data$data12.bom_items) === null || _data$data12$bom_item === void 0 ? void 0 : _data$data12$bom_item.length))) {
                                                _context.next = 12;
                                                break;
                                              }
                                              if (!data.data.bom_items[_i2].associated_product_code_bom) {
                                                _context.next = 9;
                                                break;
                                              }
                                              _context.next = 9;
                                              return getFlatBomData((_data$data$bom_items$ = data.data.bom_items[_i2]) === null || _data$data$bom_items$ === void 0 ? void 0 : _data$data$bom_items$.associated_product_code_bom, (data === null || data === void 0 ? void 0 : (_data$data13 = data.data) === null || _data$data13 === void 0 ? void 0 : (_data$data13$bom_item = _data$data13.bom_items[_i2]) === null || _data$data13$bom_item === void 0 ? void 0 : _data$data13$bom_item.quantity) * bomQuantity);
                                            case 9:
                                              _i2++;
                                              _context.next = 5;
                                              break;
                                            case 12:
                                              if (!(data.data.bom_items.length > 0)) {
                                                _context.next = 31;
                                                break;
                                              }
                                              _i3 = 0;
                                            case 14:
                                              if (!(_i3 < data.data.bom_items.length)) {
                                                _context.next = 31;
                                                break;
                                              }
                                              findsameData = false;
                                              j = 0;
                                            case 17:
                                              if (!(j < flatBomData.length)) {
                                                _context.next = 27;
                                                break;
                                              }
                                              if (!(data.data.bom_items[_i3].core_material.custom_material_id === flatBomData[j].core_material.custom_material_id)) {
                                                _context.next = 24;
                                                break;
                                              }
                                              if (bomQuantity) data.data.bom_items[_i3].quantity = data.data.bom_items[_i3].quantity * bomQuantity;
                                              data.data.bom_items[_i3].quantity = (_ref6 = data.data.bom_items[_i3].quantity * data.data.bom_items[_i3].unit_size) !== null && _ref6 !== void 0 ? _ref6 : 1;
                                              flatBomData[j].quantity = flatBomData[j].quantity + ((_data$data$bom_items$2 = data.data.bom_items[_i3]) === null || _data$data$bom_items$2 === void 0 ? void 0 : _data$data$bom_items$2.quantity);
                                              findsameData = true;
                                            ...
                                            case 24:
                                              ...
                                              break;
                                            case 27:
                                              if (!findsameData && !((_data$data$bom_items$3 = data.data.bom_items[_i3]) !== null && _data$data$bom_items$3 !== void 0 && _data$data$bom_items$3.associated_product_code_bom)) {
                                                if (bomQuantity) data.data.bom_items[_i3].quantity = data.data.bom_items[_i3].quantity * bomQuantity;
                                                data.data.bom_items[_i3].quantity = (_ref7 = data.data.bom_items[_i3].quantity * data.data.bom_items[_i3].unit_size) !== null && _ref7 !== void 0 ? _ref7 : 1;
                                                flatBomData.push(data.data.bom_items[_i3]);
                                              }
                                            case 28:
                                              _i3++;
                                              _context.next = 14;
                            ...
                            return _getFlatBomData.apply(this, arguments);
                          };
                          getFlatBomData = function _getFlatBomData2(_x3) {
                            return _getFlatBomData.apply(this, arguments);
                          };
                          setCoreMaterailBom(data === null || data === void 0 ? void 0 : (_data$data10 = data.data) === null || _data$data10 === void 0 ? void 0 : _data$data10.bom_items);
                          flatBomData = [];
                          _context3.next = 10;
                          return getFlatBomData(data === null || data === void 0 ? void 0 : (_data$data11 = data.data) === null || _data$data11 === void 0 ? void 0 : _data$data11.bom_items[0].bom_version_id);
                        case 10:
                          _context3.next = 12;
                          return (0,_constFunctions_excelFunction__WEBPACK_IMPORTED_MODULE_6__.changeActiveSheetName)(selectedBom === null || selectedBom === void 0 ? void 0 : selectedBom.label, "flatBom");
                        case 12:
                          sheetname = _context3.sent;
                          ...
                          Object.entries(bomMappingData).map(function (_ref3, index) {
                          ...
                          i = 0;
                        case 16:
                          if (!(i < flatBomData.length)) {
                            _context3.next = 24;
                            break;
                          }
                          //since it writes flat bom it ne
                          flatBomData[i].unit_size = 0;
                          flatBomData[i].total_price = 0;
                          _context3.next = 21;
                          return (0,_constFunctions_excelFunction__WEBPACK_IMPORTED_MODULE_6__.writeToExcelforBOM)(sheetname, i, flatBomData[i], bomMappingData);
                        case 21:
                          i++;
                          _context3.next = 16;
                          break;
  ...
  var writeHeadings = /*#__PURE__*/function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(i, key) {
...
/* harmony default export */ __webpack_exports__["default"] = (BomFlatBom);
...
/***/ "./node_modules/css-loader/dist/cjs.js!./src/taskpane/commonComponents/Bom/BomFlatBom/BomFlatBom.css":
/*!***********************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./src/taskpane/commonComponents/Bom/BomFlatBom/BomFlatBom.css ***!
  \***********************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\r\n.bom-get-btn-container{\r\n    display: flex;\r\n    margin-top: 20px;\r\n    gap: 10px;\r\n    }\r\n    .bom-import-container{\r\n        display: flex;\r\n       align-items: center;\r\n        flex-direction: column;\r\n        height: -webkit-fill-available;\r\n    }\r\n    .mappingWarning li{\r\n        color: red;\r\n        font-size: x-small;\r\n    }\r\n    .mappingWarning li:last-child{\r\n        list-style: none;\r\n    }\r\n    \r\n    .mappingWarning{\r\n    display: none;\r\n    }\r\n    ", "",{"version":3,"sources":["webpack://./src/taskpane/commonComponents/Bom/BomFlatBom/BomFlatBom.css"],"names":[],"mappings":";AACA;IACI,aAAa;IACb,gBAAgB;IAChB,SAAS;IACT;IACA;QACI,aAAa;OACd,mBAAmB;QAClB,sBAAsB;QACtB,8BAA8B;IAClC;IACA;QACI,UAAU;QACV,kBAAkB;IACtB;IACA;QACI,gBAAgB;IACpB;;IAEA;IACA,aAAa;IACb","sourcesContent":["\r\n.bom-get-btn-container{\r\n    display: flex;\r\n    margin-top: 20px;\r\n    gap: 10px;\r\n    }\r\n    .bom-import-container{\r\n        display: flex;\r\n       align-items: center;\r\n        flex-direction: column;\r\n        height: -webkit-fill-available;\r\n    }\r\n    .mappingWarning li{\r\n        color: red;\r\n        font-size: x-small;\r\n    }\r\n    .mappingWarning li:last-child{\r\n        list-style: none;\r\n    }\r\n    \r\n    .mappingWarning{\r\n    display: none;\r\n    }\r\n    "],"sourceRoot":""}]);
// Exports
...
/***/ "./src/taskpane/commonComponents/Bom/BomFlatBom/BomFlatBom.css":
/*!*********************************************************************!*\
  !*** ./src/taskpane/commonComponents/Bom/BomFlatBom/BomFlatBom.css ***!
  \*********************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_BomFlatBom_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../../../../node_modules/css-loader/dist/cjs.js!./BomFlatBom.css */ "./node_modules/css-loader/dist/cjs.js!./src/taskpane/commonComponents/Bom/BomFlatBom/BomFlatBom.css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_BomFlatBom_css__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ __webpack_exports__["default"] = (_node_modules_css_loader_dist_cjs_js_BomFlatBom_css__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_BomFlatBom_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_BomFlatBom_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
//# sourceMappingURL=src_taskpane_commonComponents_Bom_BomFlatBom_BomFlatBom_js.js.map