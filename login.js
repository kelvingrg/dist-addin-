...
"use strict";
/*!****************************************!*\
  !*** ./src/dialogueBox/login/login.js ***!
  \****************************************/
__webpack_require__.r(__webpack_exports__);
...
// the given anonymus function will connect with server for login , here  email and password has passed in the body of the api call
// if login successfull then the token will passed to where the  login dialogue box has been called , beside this,current dialogue box will be colsed from where it initiated
// if login failed it will remain the same dialogue box and shows the error message
    ...
    while (1) switch (_context.prev = _context.next) {
      case 0:
        $("#submit").click(function (e) {
          ...
          try {
            axios__WEBPACK_IMPORTED_MODULE_1__["default"].post("".concat(_config__WEBPACK_IMPORTED_MODULE_0__.DTX_BASE_URL, "/user/login"), {
              email: email,
              password: password
